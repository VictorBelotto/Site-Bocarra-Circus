...
const Processo2 = () => {
  return (
    <section className=' flex flex-col w-maxW max-w-hd grande:max-w-grande items-center  py-16 '>
      <Separador />
      ...
      <div className=' flex flex-col lg:flex-row w-full rounded-lg justify-between gap-8'>
        <div className='flex flex-col w-full max-w-[750px] gap-4'>
          <LazyLoadImage
            ...
            className='w-full md:max-h-[450px] object-cover'
            wrapperClassName='w-full md:max-h-[450px] object-cover'
          />
